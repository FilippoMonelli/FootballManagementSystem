...
public class AdminRegistration extends JDialog {
	...
	public AdminRegistration(DataManager data, boolean status, UserPanel rootPanel) {
	...
	private Component addSouthPanel() {
		...
		registerBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(n==0 && loginType.equals("admin")) {
					try {
						data.registerAdmin(textFieldName.getText(), textFieldSurname.getText(), textFieldUsername.getText(),
