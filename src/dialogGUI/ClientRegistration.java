...
public class ClientRegistration extends	JDialog {
	...
	public ClientRegistration(DataManager data, boolean status,UserPanel rootPanel) {
	...
	private Component addSouthPanel() {
		...
		registerBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(n==0 && loginType.equals("client")) {
					try {
						data.registerClient(textFieldName.getText(), textFieldSurname.getText(), textFieldUsername.getText(),
